<template>
  <label class="relative block w-full">
    ...
    <input
      ...
      class="h-12 w-full rounded-lg bg-white px-5 text-base text-slate-950 shadow-[0_8px_22px_rgba(15,23,42,0.08)] outline-none transition placeholder:text-slate-400 focus:border-violet-500 focus:ring-2 focus:ring-violet-500/10"
      :class="[
